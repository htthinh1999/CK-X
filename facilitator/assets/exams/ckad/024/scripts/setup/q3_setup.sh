...
rm -rf /home/candidate/exam/q3 && mkdir -p /home/candidate/exam/q3/base /home/candidate/exam/q3/overlays

cat > /home/candidate/exam/q3/base/kustomization.yaml <<'YAML'
...
cat > /home/candidate/exam/q3/base/deployment.yaml <<'YAML'
apiVersion: apps/v1
kind: Deployment
metadata:
  name: weighbridge
...
cat > /home/candidate/exam/q3/base/service.yaml <<'YAML'
apiVersion: v1
kind: Service
metadata:
  name: weighbridge
