...
rm -rf /home/candidate/exam/q15 && mkdir -p /home/candidate/exam/q15
cat > /home/candidate/exam/q15/hoist-controller.yaml <<'YAML'
apiVersion: apps/v1
kind: Deployment
metadata:
...
kubectl apply -f /home/candidate/exam/q15/hoist-controller.yaml || true
