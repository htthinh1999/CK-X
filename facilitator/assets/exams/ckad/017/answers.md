...
## Question 1 | Kustomize with commonLabels/commonAnnotations
...
## Question 3 | Ephemeral Debug Container
...
## Question 5 | Fix ErrImagePull Pod
...
## Question 6 | Deployment + PodDisruptionBudget
...
## Question 7 | CronJob with Concurrency Policy
...
## Question 8 | Extract Warning Events

> Server: `ssh ckad9988`

```bash
mkdir -p /tmp/exam/course/8
kubectl get events -n depths --field-selector type=Warning > /tmp/exam/course/8/events.txt
```

---

## Question 9 | Deny-all + Allow-web NetworkPolicies
...
## Question 10 | gRPC Liveness Probe
...
## Question 11 | Fix Service Selector
...
## Question 12 | Batch Pod with restartPolicy
...
## Question 13 | ConfigMap from Directory Mounted as Volume

> Server: `ssh ckad9988`

```bash
kubectl create configmap app-config-dir --from-file=/tmp/exam/course/13/config-files/ -n tide
...
## Question 14 | Uninstall Helm Release
...
## Question 15 | Multi-Port Service
...
## Question 16 | Deployment with Rolling Update Strategy
...
## Question 17 | Secret Exposed as Env Vars
...
## Question 18 | Deployment Rollback
...
## Question 19 | SecurityContext + NetworkPolicy
