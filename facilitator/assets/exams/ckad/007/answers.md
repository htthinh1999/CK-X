...
## Question 2 | Ingress with Path Routing (6 points)
...
## Question 3 | kubectl patch (5 points)

> Server: `ssh ckad9977`

Save the commands to `/tmp/exam/course/3/patch-commands.sh`:

```bash
mkdir -p /tmp/exam/course/3
cat > /tmp/exam/course/3/patch-commands.sh << 'EOF'
#!/bin/bash
...
chmod +x /tmp/exam/course/3/patch-commands.sh
/tmp/exam/course/3/patch-commands.sh
kubectl describe deployment patch-demo -n tide
```

---

## Question 4 | Job with Completions and Parallelism (5 points)
...
## Question 5 | HorizontalPodAutoscaler (6 points)
...
## Question 6 | kubectl debug (4 points)
...
kubectl exec troubled-app -n anchor -- ls -la /data > /tmp/exam/course/6/debug-output.txt
cat /tmp/exam/course/6/debug-output.txt
```
...
## Question 7 | NetworkPolicy with IPBlock (8 points)
...
## Question 8 | EndpointSlice (3 points)
...
} > /tmp/exam/course/8/endpoints-info.txt
cat /tmp/exam/course/8/endpoints-info.txt
```

---

## Question 9 | Pod with hostNetwork (5 points)
...
## Question 10 | StatefulSet (8 points)
...
## Question 11 | ClusterRole and ClusterRoleBinding (6 points)
...
## Question 13 | kubectl auth can-i (4 points)
...
cat > /tmp/exam/course/13/permissions.txt << 'EOF'
...
list nodes: no
EOF
cat /tmp/exam/course/13/permissions.txt
```
...
## Question 14 | DaemonSet (6 points)
...
## Question 15 | Multi-Container with Shared Volume (6 points)
...
## Question 16 | PriorityClass (5 points)
...
## Question 17 | EmptyDir with sizeLimit (4 points)
...
## Question 18 | startupProbe (5 points)
...
## Question 19 | Secret with stringData (4 points)
...
## Question 20 | Pod Affinity (6 points)
