# CKAD Simulation 7 — Answers

> Dojo Tanuki 🦝 — Tanuki des Forets
> 「狸は森に潜む」 - The tanuki hides in the forest
>
...
kubectl cp bark/copy-pod:/etc/passwd /tmp/exam/course/20/passwd

# If kubectl cp reports a leading '/' warning, it still copies. Verify:
cat /tmp/exam/course/20/passwd
```
