...
# Setup for Question 16: ClusterRole and ClusterRoleBinding
...
echo "Setup complete for Question 16: Environment ready for creating ClusterRole 'pod-reader' and ClusterRoleBinding 'read-pods'"
exit 0
