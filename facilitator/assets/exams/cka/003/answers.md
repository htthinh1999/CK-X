...
## Question 3 — PVC + Pod mount (cluster2 / beta)
...
## Question 4 — ConfigMap + Pod env (cluster1 / alpha)
...
## Question 5 — Secret + Pod env (cluster2 / beta)
...
## Question 6 — Scale + rolling update (cluster1 / alpha)
...
## Question 7 — CronJob (cluster2 / beta)
...
## Question 8 — RBAC (cluster1 / alpha)
...
## Question 9 — Default-deny NetworkPolicy (cluster2 / beta)
...
## Question 10 — Schedule with nodeSelector (cluster1 / alpha)
...
## Question 11 — Deployment + NodePort (cluster2 / beta)
...
## Question 12 — Fix the broken Deployment (cluster1 / alpha)
